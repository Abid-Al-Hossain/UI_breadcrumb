...
export default function Page() {
  const [state, setState] = useState<BreadcrumbState>(DEFAULT_BREADCRUMB_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Breadcrumb Studio" controls={controls} preview={output} /></AppShell>;
}
