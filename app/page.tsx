...
const nativeFeatures = [
  "Navigation model: items, current state, disabled state, separators, groups, nested levels",
  "Keyboard behavior: roving focus, typeahead, arrow keys where APG/Radix patterns apply",
  "Responsive behavior: collapsed/mobile modes, overflow and alignment",
  "Accessibility: nav labels, aria-current, menu roles, step state labels"
] as const;

const defaultState: StudioState = {
  title: "Breadcrumb Studio",
  description: "Native breadcrumb pattern with preview/export-honest controls.",
  label: "Breadcrumb",
  value: "breadcrumb",
...
const presets: Preset[] = [
  { family: "navigation", archetype: "SaaS", variant: "glass", size: "balanced", tags: ["premium", "dark", "export-safe"], state: defaultState },
  { family: "navigation", archetype: "Editorial", variant: "soft", size: "spacious", tags: ["marketplace", "content"], state: { ...defaultState, density: "spacious", background: "#f8fafc", foreground: "#0f172a", border: "#cbd5e1", accent: "#f59e0b", shadow: 10 } },
  { family: "navigation", archetype: "Admin", variant: "crisp", size: "compact", tags: ["dashboard", "dense"], state: { ...defaultState, density: "compact", radius: 10, width: 320, height: 140, gap: 8, fontSize: 14, accent: "#22c55e" } },
  { family: "navigation", archetype: "Commerce", variant: "hero", size: "spacious", tags: ["commerce", "bold"], state: { ...defaultState, title: "Conversion Breadcrumb", accent: "#fb7185", background: "#1e1b4b", width: 420, height: 220, shadow: 36 } },
];
...
export default function Page() {
  ...
  const [downloadName, setDownloadName] = useState("breadcrumb-component");
    ...
    <main className="mx-auto grid min-h-screen max-w-[1500px] gap-6 px-5 py-6 lg:grid-cols-[430px_1fr]">
      <aside className="space-y-5">
        <header className="rounded-[2rem] border border-white/10 bg-slate-950/70 p-5 shadow-2xl shadow-black/30">
          ...
          <h1 className="mt-3 text-3xl font-black tracking-tight">Breadcrumb Studio</h1>
          <p className="mt-2 text-sm text-slate-400">Self-contained, React-only, buyer-ready breadcrumb generator.</p>
        </header>
