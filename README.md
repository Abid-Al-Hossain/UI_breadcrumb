# UI Foundry Breadcrumb Studio

Standalone visual Breadcrumb generator built with Next.js, React, and TypeScript.

Standalone Breadcrumb component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Breadcrumb UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Breadcrumb generator
...
The editor is focused on controls that are native to Breadcrumb and useful in real product work:
- levels, current page, separator, icon, overflow/collapse intent, and link/current states
- spacing, typography, color, hover, focus, active, and surface style
- marketing, dashboard, docs, commerce, and compact breadcrumb variants
- nav landmark and aria-current semantics
- React export for breadcrumb navigation

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Breadcrumb.
...
This repo is intended to publish as Abid-Al-Hossain/UI_breadcrumb.
